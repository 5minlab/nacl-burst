...
NaCl Burst is a Unity Package Manager package that exposes a `NaCl.NaCl` API while replacing native plugin and TweetNaCl dependencies with a Burst-backed C# implementation.

The public method names use the `Crypto*` spelling.
